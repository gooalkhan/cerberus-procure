...
| **Container_Item** | Container_Item_ID (PK), PO_Item_ID (FK, NN), Container_ID (FK), CI_ID (FK), BL_ID(FK), Item_ID(FK, NN), Unit_Price, Currency, Load_Qty, Gross_Weight, Net_Weight, Cbm, Temporary_ETA, UUID(UK, NN) Remark | 컨테이너 적재 품목 매핑. |
